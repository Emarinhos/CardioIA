...
**Link público para o dataset completo:** [INSERIR LINK DO GOOGLE DRIVE / ONEDRIVE] (garanta acesso "qualquer pessoa com o link" para a correção da FIAP).
...
**Link público para o subconjunto de imagens usado neste projeto:** [INSERIR LINK DO GOOGLE DRIVE / ONEDRIVE] (garanta acesso "qualquer pessoa com o link" para a correção da FIAP).
